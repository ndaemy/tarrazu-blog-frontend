              ...
              <div className='mb-4'>
                ...
                <div className='ml-4'>
                  <p className='mb-2'>
                    ...
                    서비스입니다. 관리자용 웹사이트를 구축하여 전공, 기수,
                    유저를 관리할 수 있도록 하였고, 어플에서는 사용자 정보 공유,
                    교수진 연락처 공유, 내 정보 수정, 공지사항 확인을 할 수
                    있습니다.
                  </p>
                  <Tags
                    names={[
              ...
              <div className='mb-6'>
                ...
                <div className='ml-4'>
                  <p className='mb-2'>
                    ...
                    있습니다. 멋쟁이 사자처럼은 이두희 대표를 필두로
                    2019년까지는 "내가 직접 프로그래밍 하겠다.", "Hack your
                    life!"를 캐치프레이즈로 하여 비전공자들 혹은 전공자 중에
                    웹프로그래밍을 직접 하지 못하는 사람들에게 스스로 만들고
                    싶은 서비스를 만들 수 있도록 교육해주는 코딩 교육
                    동아리였습니다만, 2020년에는 "스타트업 사관학교"로 새로운
                    발돋움을 준비하고 변화해 가는 중입니다. 자신이 원하는
                    아이디어로 스스로 서비스를 만들고, 더 나아가 세상을 바꾸는
                    서비스로 창업을 하는 것까지를 목표로 삼고 있는 동아리이자
                    단체입니다.
                  </p>
                </div>
              </div>
